...
class SentenceTest extends FunSuite {
  ...
  test("get bounderies from sentence") {
     val words =  List( new MorfWord ("a","J^------------") , new MorfWord ("kter�","J,------------"), new MorfWord ("a","J^------------"))
    ...
    test("get segments from sentence") {
     val words =  List( new MorfWord ("a","J^------------") , new MorfWord ("ale","J^------------"), new MorfWord ("kter�","J,------------"), new MorfWord ("a","J^------------"))
     val sentence = new MorfSentence(words)
