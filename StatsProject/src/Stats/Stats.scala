 ...
 def baseInformation(segData : List[(String, Array[(Int, Int)])])  =  {
    ...
    groupSegments.foreach(f => println("Poèet segmentù:" + f._1.toString + " poèet vìt: " + f._2))
     ...
     groupSegmentsDetail.foreach(m => {
    	 		println("Poèet segmentù:" + m._1.toString + " poèet vìt: " + m._2)
    	 		m._3.foreach(n => println("\t Konfigurace :" + n._2 + " poèet : " + n._1 ))
   ...
   levelDiff.foreach(f =>  {
     ...
     println("Rozdíl " + f._1 + " celkový poèet dvojic " + wholeCount + " dojice : " + f._2)
   })
